  ...
  return (
    <section className={styles.container}>
      <h1 className={styles.title}>
        Réparation, remplacement et pose de toiture neuve à Nantes et en Loire-Atlantique (44)
      </h1>
      ...
      <p className={styles.intro}>
        ...
        réfection complète</strong> à Nantes et dans tout le département de la Loire-Atlantique.
      ...
      <SectionImage
        src="/image2.avif"
        alt="Dépose et remplacement complet d'une toiture ancienne à Nantes"
      />

      {/* Conclusion CTA */}
      <p className={styles.intro}>
        Faites appel à <strong>Elite Couverture</strong> pour tous vos besoins en réparation, 
        remplacement ou pose de toiture à <strong>Nantes, Saint-Nazaire, Rezé, Orvault, 
        et partout en Loire-Atlantique</strong>. Profitez de notre <strong>devis gratuit</strong>, 
